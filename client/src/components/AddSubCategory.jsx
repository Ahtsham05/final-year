...
const AddSubCategory = ({close,fetchSubCategories}) => {
        ...
        <div className='w-full max-w-lg bg-white px-2 py-4 grid gap-3'>
            ...
            <div className='grid'>
                <form className='grid gap-4' onSubmit={handleSubmit}>
                    ...
                    <button className={`text-sm border p-2 rounded ${validateFields ? 'border-primary200 hover:bg-primary200':'border-gray-500 hover:bg-gray-500'} hover:text-white`}>Add Sub Category</button>
                </form>
            </div>
        </div>
    </section>
